    ...
    <div class="generator">
        ...
        >
          ...
          >
            <a-input
                ...
                :placeholder="t('generator.placeholder.username')"
            />
          </a-form-item>
          ...
          >
            <a-input
                v-model:value="email"
                :placeholder="t('generator.placeholder.email')"
            />
          </a-form-item>
          ...
          >
            <a-input
                ...
                :placeholder="t('generator.placeholder.comment')"
            />
          </a-form-item>
      ...
      <a-row class="generator-output" :gutter="16">
        ...
        <a-col :span="12">
          <a-spin :spinning="resultSpinning">
            <h-multiline
                :title="t('generator.output.public')"
                :value="publicKey"
                class="output"
            />
          </a-spin>
...
import {generateKey, EllipticCurveName} from 'openpgp'
...
async function generateKeyPair(
  ...
  const {privateKey, publicKey, revocationCertificate} = await generateKey({
    type: algorithm,
    curve: curve,
    userIDs: [{name: username, email: email, comment: comment}],
