  ...
  <h-single-layout mode="middle" :width="900">
      <div style="display: flex">
        ...
        <div class="flexC">
          ...
          <div class="midDiv">
            ...
            <span style="text-shadow: 1px 1px 0 #444; color: #000 !important"
            >Shadow</span
            >
            <span style="color: #fff !important">White Text</span>
            <span style="text-shadow: 1px 1px 0 #444; color: #fff !important"
            >Shadow</span
            >
          </div>
        ...
        <div class="flexC">
          ...
          <div
              v-for="(i, index) in 21"
              :key="i"
              style="display: flex; width: 100%; padding: 0px 5px"
          >
      ...
      <a-card style="width: 90%; display: flex; flex-direction: column">
        <div style="display: flex">
          ...
          <div style="width: 33%">
            <span>Blue</span><span><span style="opacity: 0">1</span></span>
...
import { ColorType, convertColor } from 'he3-common'
...
const changeColor = (e: any) => {
  selectColor.value = convertColor(
...
watch(
    ...
    () => {
      ...
      let rgbArr = convertColor(selectColor.value, ColorType.RGB).match(
          /[1-9][0-9]*/g,
      )
      if (rgbArr) {
