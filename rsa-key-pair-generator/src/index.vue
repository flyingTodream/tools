...
<template>
  <h-single-layout mode="middle" :width="1280">
    <div class="generator">
      ...
      <RadioGroup v-model:value="alg" :options="algOptions" />
    </a-form-item> -->
        ...
        <a-collapse ghost class="collapse">
          <a-collapse-panel :header="t('advance')">
            ...
            <a-form-item
                v-if="privateKeyFormat === 'Putty'"
                :label="t('private.comment')"
            >
              <a-input
                  v-model:value="privateKeyComment"
                  @change="debouncedGenerate"
              />
            </a-form-item>
            ...
            <a-form-item
                v-if="publicKeyFormat === 'OpenSSH'"
                :label="t('public.comment')"
            >
              <a-input
                  v-model:value="publicKeyComment"
                  @change="debouncedGenerate"
              />
            </a-form-item>
          </a-collapse-panel>
