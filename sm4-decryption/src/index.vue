  ...
  <h-text-transform
    ...
    <template #option>
      <a-space style="margin-top: 16px">
        ...
        <span>
          <a-select v-model:value="inputType" @change="callCryptMethod">
...
const sample = ref(
  'ChYToJet2n4njlFdUnewRnPkjOVzIgoth0oUpJ+I9RZuCxyVrnX8KEUZU/IPhkfN'
);
...
const SynchronizeInput = () => {
  switch (passwordType.value) {
    ...
    case OutputType.Utf8:
      cryptRef.value.raw =
        'Bf9oW/1XLAwJZTCPRVrMtRlZgNVmEqZ0LXkJONwgAOqRdhm1JExMfFByleg5TTu0';
