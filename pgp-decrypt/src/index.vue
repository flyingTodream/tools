<template>
  <h-single-layout mode="middle" :width="1280">
    <div class="decrypt">
      ...
      <h-multiline
          :result-desc="t('decrypt.title.result')"
...
import {decrypt, readPrivateKey, decryptKey, readMessage} from 'openpgp'
...
function handleDecrypt() {
  decryptMessage(message.value, privateKey.value, passphrase.value).then(
      (message) => {
